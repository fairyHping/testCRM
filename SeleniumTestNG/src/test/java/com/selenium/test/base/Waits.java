 ...
 * so use WaitTool抯 explicit wait methods as much as possible.
...
public class Waits {
	...
	public static Boolean waitForElementInvisible(WebDriver driver, final WebElement element, int timeOutInSeconds) {
		Boolean result;
		try{	
			//To use WebDriverWait(), we would have to nullify implicitlyWait(). 
			//Because implicitlyWait time also set "driver.findElement()" wait time.  
